...
namespace Vanguard.Domain.Entities.CourseAggregate
{
    public class Module : Entity<ModuleId>
    {
        ...
        private Module(ModuleId id, string title, string description, int orderIndex) : base(id)
        {
        ...
        public static Module Create(string title, string description, int orderIndex)
        {
            return new Module(ModuleId.CreateUnique(), title, description, orderIndex);
        }
